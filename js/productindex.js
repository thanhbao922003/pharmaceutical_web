...
document.addEventListener("DOMContentLoaded", function () {
    const productsData = [
      {
        id: 1,
        imgSrc:
          "https://data-service.pharmacity.io/pmc-upload-media/production/pmc-ecm-core/products/P17315_1_l.webp",
        alt: "post",
      ...
      },
      {
        id: 2,
        imgSrc:
          "https://data-service.pharmacity.io/pmc-upload-media/production/pmc-ecm-core/products/P18107_1_l.webp",
        alt: "post",
        category: "Thuốc không kê đơn",
        categoryName: "Dược phẩm",
        ...
        subImg:
          "https://data-service.pharmacity.io/pmc-upload-media/production/pmc-ecm-core/products/P18107_2_l.webp",
      ...
      },
      {
        id: 3,
        imgSrc:
          "https://data-service.pharmacity.io/pmc-upload-media/production/pmc-ecm-core/products/P03195_1_l.webp",
        alt: "post",
      ...
      },
      {
        id: 4,
        imgSrc:
          "https://data-service.pharmacity.io/pmc-upload-media/production/pmc-ecm-core/__sized__/products/P26350_1-thumbnail-510x510-70.jpg",
        alt: "post",
      ...
      },
      {
        id: 5,
        imgSrc:
          "https://data-service.pharmacity.io/pmc-upload-media/production/pmc-ecm-core/__sized__/products/P08401_11-thumbnail-510x510-70.jpg",
        alt: "post",
        category: "Thực phẩm dinh dưỡng",
        categoryName: "Chăm sóc sức khỏe",
      ...
      },
      {
        id: 6,
        imgSrc:
          "https://data-service.pharmacity.io/pmc-upload-media/production/pmc-ecm-core/__sized__/products/P25117_1-thumbnail-510x510-70.jpg",
        alt: "post",
      ...
      },
      {
        id: 7,
        imgSrc:
          "https://data-service.pharmacity.io/pmc-upload-media/production/pmc-ecm-core/__sized__/products/P22985_1-thumbnail-510x510-70.jpg",
        alt: "post",
        category: "Dụng cụ sơ cứu",
        categoryName: "Chăm sóc sức khỏe",
        ...
        description:
          "Công dụng. Miếng dán thảo dược giúp cải thiện tình trạng khó chịu như đau đầu, viêm khớp, đau dây thần kinh, thoát vị đĩa đệm, căng cơ, đau vai gáy, vết bầm tím, bong gân do va đập. Cách sử dụng. Làm sạch phần da, lau khô vùng da bị đau, gỡ miếng cao dán ra khỏi tấm che, phủ mặt ngoài và dán vào chỗ đau. Lưu ý.",
        subImg: "",
      ...
      },
      {
        id: 8,
        imgSrc:
          "https://data-service.pharmacity.io/pmc-upload-media/production/pmc-ecm-core/__sized__/products/P21744_1-thumbnail-510x510-70.jpg",
        alt: "post",
      ...
      },
      {
        id: 9,
        imgSrc:
          "https://data-service.pharmacity.io/pmc-upload-media/production/pmc-ecm-core/__sized__/products/P08241_3-thumbnail-510x510-70.jpg",
        alt: "post",
        category: "Khẩu trang y tế",
        categoryName: "Chăm sóc sức khỏe",
        ...
        description:
          "Thành phần: Polyester, Polyolefin, lớp lọc. Công dụng: Ngăn chặn các vi-rút gây bệnh, ngăn khói bụi, phấn hoa gây dị ứng. Cách sử dụng: Mở rộng khẩu trang từ vị trí mũi tên, lần lượt đeo hai quai vào vành tai, điều chỉnh cho vừa vặn. Bảo quản: Nơi khô ráo thoáng mát, sạch sẽ, tránh ánh nắng và nhiệt độ cao.",
        subImg: "",
      ...
      },
      {
        id: 10,
        imgSrc:
          "https://data-service.pharmacity.io/pmc-upload-media/production/pmc-ecm-core/__sized__/products/P22015_1N-thumbnail-510x510-70.jpg",
        alt: "post",
        category: "Khẩu trang y tế",
        categoryName: "Chăm sóc sức khỏe",
        ...
        description:
          "Thành phần. Khẩu trang NIVA 95 được tạo bởi 2 lớp vải không dệt cao cấp không thấm nước, bụi, dầu, giọt bắn, 1 lớp vải bông không dệt và 1 lớp màng lọc. Màu sắc: Trắng. Công dụng. Ngăn vi khuẩn, khói, bụi, dầu, giọt bắn, phòng các dịch bệnh nguy hiểm lây qua đường hô hấp. Cách sử dụng.",
        subImg:
          "https://data-service.pharmacity.io/pmc-upload-media/production/pmc-ecm-core/products/P22015_3.jpg",
      ...
      },
      {
        id: 11,
        imgSrc:
          "https://data-service.pharmacity.io/pmc-upload-media/production/pmc-ecm-core/__sized__/products/P07218_1_l-thumbnail-510x510.webp",
        alt: "post",
        category: "Chống muỗi",
        categoryName: "Chăm sóc sức khỏe",
        ...
        description:
          "Thành phần. Diethyltoluamide 13%. Công dụng. Sử dụng Soffell làm cho muỗi tránh xa bạn trong suốt thời gian 10 giờ mà vẫn giữ cho làn da mềm mại. Cách sử dụng: Thoa đều lên những vùng da hở như cổ, tay, chân hoặc quần áo, chăn màn. Soffell duy trì hiệu quả xua muỗi trong vòng 10 giờ.",
        subImg: "",
      ...
      },
      {
        id: 12,
        imgSrc:
          "https://data-service.pharmacity.io/pmc-upload-media/production/pmc-ecm-core/products/P13180_1_l.webp",
        alt: "post",
        category: "Chống muỗi",
        categoryName: "Chăm sóc sức khỏe",
        ...
        description:
          "Thành phần. Diethyltoluamide 15%. Công dụng. Chống muỗi hiệu quả trong 10 giờ. Dạng kem không nhờn rít. Hương oải hương dịu nhẹ, thoải mái. Aloe Vera và Vitamin E giúp da mềm mại và mịn màng hơn.",
        subImg:
          "https://data-service.pharmacity.io/pmc-upload-media/production/pmc-ecm-core/products/P13180_3_l.webp",
      ...
      },
      {
        id: 13,
        imgSrc:
          "https://data-service.pharmacity.io/pmc-upload-media/production/pmc-ecm-core/products/P16089_1_l.webp",
        alt: "post",
      ...
      },
      {
        id: 14,
        imgSrc:
          "https://data-service.pharmacity.io/pmc-upload-media/production/pmc-ecm-core/products/P16091_1.jpg",
        alt: "post",
        category: "Dầu tràm, dầu xoa bóp",
        categoryName: "Chăm sóc sức khỏe",
      ...
      },
      {
        id: 15,
        imgSrc:
          "https://data-service.pharmacity.io/pmc-upload-media/production/pmc-ecm-core/products/P21654_11.jpg",
        alt: "post",
        category: "Nhiệt kế",
      ...
      },
      {
        ...
        description:
          "Công dụng. Đo thân nhiệt cơ thể. Thông tin kỹ thuật. Đo thân nhiệt bằng công nghệ cảm ứng mạ vàng, cho kết quả nhanh và chính xác trong 30 giây. Đầu dẻo, chống thấm nước. Báo tiếng bíp sau khi đo. Sai số chỉ 0,2 độ C. Sử dụng pin hay điện? Pin. Lưu ý loại pin/ nguồn điện: Pin CR1632.",
        subImg:
          "https://data-service.pharmacity.io/pmc-upload-media/production/pmc-ecm-core/products/P08457_5.jpg",
      ...
      },
      {
        ...
        description:
          "Thông số kỹ thuật. - Trọng lượng: 319 g (bao gồm pin). - Kích thước: 146 x 65 x 46 mm. - Phương pháp đo: Đo dao động. - Tầm đo: Huyết áp: 20 - 280 mmHg. - Nhịp tim: 40 - 200 nhịp/phút.",
        subImg:
          "https://data-service.pharmacity.io/pmc-upload-media/production/pmc-ecm-core/products/P09292_2_l.webp",
      ...
      },
      {
        ...
        description:
          "Công dụng. Sử dụng để đo huyết áp, nhịp tim ở người lớn. Thông số kĩ thuật. Hiển thị: Màn hình kĩ thuật số LCD. Phương pháp đo: Quét xung/Phương pháp xác định dao động. Dải đo: Huyết áp (0-299) mmHg, nhịp tim (40-199) nhịp/giây. Độ chính xác: Huyết áp ±3mmHg, nhịp tim ± 5% của kết quả đo được. Dung lượng bộ nhớ: 90 lần đo. Cảm ứng áp suất: Cảm biến áp xuất bán dẫn.",
        subImg: "",
      ...
      },
      {
        id: 19,
        imgSrc:
          "https://data-service.pharmacity.io/pmc-upload-media/production/pmc-ecm-core/products/P26063_1.jpg",
        alt: "post",
        ...
        info: "",
        description:
          "Công dụng. Kết quả chính xác. Tiết kiệm que thử. Trả kết quả sau 5 giây. Đặc điểm nổi bật. Chỉ cần một mẩu máu nhỏ: Que thử được thiết kế để dễ dàng trích lấy máu vào đầu mẫu thử. Chỉ cần mẫu máu nhỏ 0,6 μL. Kết quả nhanh: Sử dụng que thử trước thời hạn sử dụng. Nhận kết quả sau 5 giây. Tiết kiệm que thử: Khả năng lấy mẫu Second-Chance cho phép bạn lấy thêm máu khi lượng máu lúc đầu không đủ để xét nghiệm.",
        subImg:
          "https://data-service.pharmacity.io/pmc-upload-media/production/pmc-ecm-core/products/P26063_2.jpg",
      ...
      },
      {
        id: 20,
        imgSrc:
          "https://data-service.pharmacity.io/pmc-upload-media/production/pmc-ecm-core/products/P09468_1_l.webp",
        alt: "post",
        category: "Máy đo đường huyết",
        categoryName: "Thiết bị y tế",
        ...
        description:
          "Thành phần. Hộp 100 kim đóng gói trong bao tiệt trùng. Công dụng. Kim chích lấy máu bệnh nhân. Đặc tính kĩ thuật. Đầu kim được vát tam giác hạn chế tối đa cảm giác khó chịu. Tương thích các loại bút lấy máu trên thị trường. Hướng dẫn sử dụng.",
        subImg:
          "https://data-service.pharmacity.io/pmc-upload-media/production/pmc-ecm-core/products/P09468_2_l.webp",
      ...
      },
      {
        ...
        description:
          "Thành phần. - Máy xông khí dung Microlife NEB200. - Phụ kiện máy đầy đủ bao gồm: 2 mask (người lớn và trẻ em), 1 cốc đựng thuốc, 1 càng xông họng, 1 càng xông mũi, 3 miếng lọc khí, dây dẫn khí, sách hướng dẫn sử dụng, phiếu bảo hành sản phẩm. Công dụng: Sản phẩm được dùng để phòng và điều trị bệnh liên quan đến đường hô hấp. Thông tin kỹ thuật.",
        subImg:
          "https://data-service.pharmacity.io/pmc-upload-media/production/pmc-ecm-core/products/P12876_2_l.webp",
      ...
      },
      {
        id: 22,
        imgSrc:
          "https://data-service.pharmacity.io/pmc-upload-media/production/pmc-ecm-core/products/P25921_2.jpg",
        alt: "post",
      ...
      },
      {
        id: 23,
        imgSrc:
          "https://data-service.pharmacity.io/pmc-upload-media/production/pmc-ecm-core/products/P26038_1.jpg",
        alt: "post",
        category: "TPCN Nhóm dạ dày",
        categoryName: "Thực phẩm chức năng",
        ...
        info: "",
        description:
          "Thành phần. 240 mg Hỗn hợp cao chiết xuất bởi các thảo mộc. (Chi tử 510 mg, Hương phụ 560mg, Huyền hồ 396 mg). Bột ô tặc cốt 235mg. Tinh bột nghệ 28mg. Cao khô cam thảo 34mg. Phụ liệu vừa đủ: Natri benzoate, Talc,…",
        subImg:
          "https://data-service.pharmacity.io/pmc-upload-media/production/pmc-ecm-core/products/P26038_2.jpg",
      ...
      },
      {
        id: 24,
        imgSrc:
          "https://data-service.pharmacity.io/pmc-upload-media/production/pmc-ecm-core/products/P24909_1.jpg",
        alt: "post",
      ...
      },
      {
        id: 25,
        imgSrc:
          "https://data-service.pharmacity.io/pmc-upload-media/production/pmc-ecm-core/products/P24263_1.jpg",
        alt: "post",
        category: "TPCN Cho Huyết Áp",
        categoryName: "Thực phẩm chức năng",
      ...
      },
      {
        id: 26,
        imgSrc:
          "https://data-service.pharmacity.io/pmc-upload-media/production/pmc-ecm-core/products/P24936_1.jpg",
        alt: "post",
      ...
      },
      {
        id: 27,
        imgSrc:
          "https://data-service.pharmacity.io/pmc-upload-media/production/pmc-ecm-core/products/P02230_1_l.webp",
        alt: "post",
        category: "TPCN Nhóm đường huyết",
        categoryName: "Thực phẩm chức năng",
        ...
        description:
          "Thành phần. Cao lá dây thìa canh (Gymnema sylvestre) 0,185g (tương đương 1,5g lá khô). Amidon, aerosol, PEG 6000, tween 80, talc, magnesi stearate, koli sorbat,...vừa đủ 1 viên. Công dụng. Hỗ trợ sinh tân, chỉ khát, làm hạ đường huyết hỗ trợ phòng ngừa bệnh tiểu đường, ổn định đường huyết và ngăn ngừa các biến chứng của bệnh tiểu đường. Đối tượng sử dụng.",
        subImg: "",
      ...
      },
      {
        id: 28,
        imgSrc:
          "https://data-service.pharmacity.io/pmc-upload-media/production/pmc-ecm-core/products/P22919_1.jpg",
        alt: "post",
      ...
      },
      {
        id: 29,
        imgSrc:
          "https://data-service.pharmacity.io/pmc-upload-media/production/pmc-ecm-core/products/P26046_1.jpg",
        alt: "post",
        category: "TPCN Nhóm hô hấp",
        categoryName: "Thực phẩm chức năng",
        ...
        info: "",
        description:
          "Thành phần. Húng chanh 45, 00 g. Núc nác 11, 25 g. Cao lá thường xuân khô 0, 63 g. Cineol 0, 08 g. Phụ liệu (sorbitol dung dich 70%, hương liệu, potassium sorbate) vừa đủ 1 lọ 90ml.",
        subImg:
          "https://data-service.pharmacity.io/pmc-upload-media/production/pmc-ecm-core/products/P26046_2.jpg",
      ...
      },
      {
        id: 30,
        imgSrc:
          "https://data-service.pharmacity.io/pmc-upload-media/production/pmc-ecm-core/products/P25864_1.jpg",
        alt: "post",
        ...
        info: "",
        description:
          "Thành phần. Cao ginkgo biloba: 180 mg. Nattokinase: 100 FU. Cao Lạc tiên: 70 mg. Cao bình vôi: 30 mg. Cao Vông nem: 30 mg.",
        subImg:
          "https://data-service.pharmacity.io/pmc-upload-media/production/pmc-ecm-core/products/P25864_2.jpg",
      ...
      },
      {
        id: 31,
        imgSrc:
          "https://data-service.pharmacity.io/pmc-upload-media/production/pmc-ecm-core/products/P21695_11.jpg",
        alt: "post",
        category: "TPCN Nhóm thần kinh",
        categoryName: "Thực phẩm chức năng",
        ...
        subImg:
          "https://data-service.pharmacity.io/pmc-upload-media/production/pmc-ecm-core/products/P21695_1.jpg",
      ...
      },
      {
        id: 32,
        imgSrc:
          "https://data-service.pharmacity.io/pmc-upload-media/production/pmc-ecm-core/products/P26033_1.jpg",
        alt: "post",
        ...
        info: "",
        description:
          "Thành phần. Canxi gluconat: 1000mg (có chứa 93mg Canxi), Magie (Magie oxit): 200mg, Kēm (Kem oxit): 12.5mg, Vitamin K2 (menaquinone MK-7): 60µg, Vitamin D3 (cholecalciferol): 400IU (10µg). Phụ liệu: gelatin (vỏ nang), chất độn: tinh bột ngô, chất chống động vốn; các muối magie của các axit béo, chất chống đông vón: silicon dioxit. Công dụng. Hỗ trợ xương chắc khỏe, giúp giảm nguy cơ loãng xương ở người lớn và còi xương ở trẻ nhỏ do thiếu vitamin D3. Đối tượng sử dụng: Trẻ em trên 9 tuổi và người lớn, phụ nữ có thai và cho con bú.",
        subImg: "",
      ...
      },
      {
        id: 33,
        imgSrc:
          "https://data-service.pharmacity.io/pmc-upload-media/production/pmc-ecm-core/products/P25941_1.jpg",
        alt: "post",
        category: "TPCN Nhóm cơ xương khớp",
        categoryName: "Thực phẩm chức năng",
        ...
        info: "",
        description:
          "Thành phần. Bột vỏ trứng, Whey protein hoạt tính cô đặc từ sữa bò, Vitamin D3, phụ liệu. Protein 0,035g. Chất béo 0,05g. Carbohydrate 0,63g. Muối tương đương 0,002g.",
        subImg: "",
      ...
      },
      {
        id: 34,
        imgSrc:
          "https://data-service.pharmacity.io/pmc-upload-media/production/pmc-ecm-core/products/P24856_1.jpg",
        alt: "post",
        ...
        info: "",
        description:
          "Thành phần. Mỗi viên nang cứng có chứa: Chiết xuất lá sen 220mg. Chiết xuất kim ngân hoa 100mg. Chiết xuất nấm linh chi 60mg. Chiết xuất sâm đất 50mg",
        subImg:
          "https://data-service.pharmacity.io/pmc-upload-media/production/pmc-ecm-core/products/P24856_2.jpg",
      ...
      },
      {
        id: 35,
        imgSrc:
          "https://data-service.pharmacity.io/pmc-upload-media/production/pmc-ecm-core/products/P24911_1.jpg",
        alt: "post",
        category: "TPCN giảm cân",
        categoryName: "Thực phẩm chức năng",
        ...
        description:
          "Thành phần. - Belaunja extract: 300 mg. - Mangastin extract: 100 mg. - Psilio husk powder: 200 mg. - Phụ gia: vừa đủ 1 viên. Công dụng.",
        subImg:
          "https://data-service.pharmacity.io/pmc-upload-media/production/pmc-ecm-core/products/P24911_2.jpg",
      ...
      },
      {
        id: 36,
        imgSrc:
          "https://data-service.pharmacity.io/pmc-upload-media/production/pmc-ecm-core/products/P25870_1.jpg",
        alt: "post",
        ...
        subImg:
          "https://data-service.pharmacity.io/pmc-upload-media/production/pmc-ecm-core/products/P25870_2.jpg",
      ...
      },
      {
        id: 37,
        imgSrc:
          "https://data-service.pharmacity.io/pmc-upload-media/production/pmc-ecm-core/products/P21697_1_l.webp",
        alt: "post",
        category: "TPCN Chăm sóc sắc đẹp",
        categoryName: "Thực phẩm chức năng",
      ...
      },
      {
        id: 38,
        imgSrc:
          "https://data-service.pharmacity.io/pmc-upload-media/production/pmc-ecm-core/products/P22986_1.jpg",
        alt: "post",
      ...
      },
      {
        id: 39,
        imgSrc:
          "https://data-service.pharmacity.io/pmc-upload-media/production/pmc-ecm-core/products/P22097_1.jpg",
        alt: "post",
        category: "Chăm sóc mặt",
        categoryName: "Chăm sóc sắc đẹp",
        ...
        description:
          "Thành phần. Aqua (Water), Niacinamide, Propylene Glycol, Butylene Glycol, Betaine, Phenoxyethanol, PPG-26-Buteth-26, Panthenol, PEG-40 Hydrogenated Castor Oil, Caprylyl Glycol, Carbomer, Disodium EDTA, Sodium Hydroxide. Công dụng. Sản phẩm dưỡng da, giúp làm sáng da, giúp tăng độ đàn hồi cho da, giúp da mịn màng. Đối tượng sử dụng: Trên 12 tuổi",
        subImg:
          "https://data-service.pharmacity.io/pmc-upload-media/production/pmc-ecm-core/products/P22097_1a.jpg",
      ...
      },
      {
        id: 40,
        imgSrc:
          "https://data-service.pharmacity.io/pmc-upload-media/production/pmc-ecm-core/products/P25518_2.jpg",
        alt: "post",
        ...
        info: "",
        description:
          "Thành phần. AQUA, ISOPROPYL PALMITATE, OCTOCRYLENE, HOMOSALATE, BUTYL METHOXYDIBENZOYLMETHANE, ALCOHOL DENAT, GLYCERIN, SILICA, POLYGLYCERYL-3 DIISOSTEARATE, PVP/HEXADECENE COPOLYMER, CETEARYL ALCOHOL, PHENOXYETHANOL. Công dụng. Kem chống nắng cho da hàng ngày, đồng thời giúp cung cấp độ ẩm cho da. Sản phẩm thích hợp cho da nhạy cảm.",
        subImg: "",
      ...
      },
      {
        id: 41,
        imgSrc:
          "https://data-service.pharmacity.io/pmc-upload-media/production/pmc-ecm-core/products/P03574_1.jpg",
        alt: "post",
        category: "Sản phẩm chống nắng",
        categoryName: "Chăm sóc sắc đẹp",
        ...
        description:
          "Thành phần: Cyclopentasiloxane, Water, Alcohol, Zinc Oxide, Ethylhexyl Methoxycinnamate, Glycerin, Dimethicone,... Công dụng: Sử dụng trên da để ngăn ngừa hay giảm sự rám nắng, kháng khuẩn. Hướng dẫn sử dụng: Lắc kỹ, thoa nhẹ đều khắp vùng mặt và toàn thân trước khi đi ra ngoài nắng. Thoa lại khi ra mồ hôi hoặc bơi lâu dưới nước để có hiệu quả chống nắng tốt nhất. Bảo quản:",
        subImg:
          "https://data-service.pharmacity.io/pmc-upload-media/production/pmc-ecm-core/products/P03574_2.jpg",
      ...
      },
      {
        id: 42,
        imgSrc:
          "https://data-service.pharmacity.io/pmc-upload-media/production/pmc-ecm-core/products/P01352_1_l.webp",
        alt: "post",
      ...
      },
      {
        id: 43,
        imgSrc:
          "https://data-service.pharmacity.io/pmc-upload-media/production/pmc-ecm-core/products/P14735_11.jpg",
        alt: "post",
        category: "Dụng cụ làm đẹp",
        categoryName: "Chăm sóc sắc đẹp",
      ...
      },
      {
        id: 44,
        imgSrc:
          "https://data-service.pharmacity.io/pmc-upload-media/production/pmc-ecm-core/products/P24394_4.jpg",
        alt: "post",
        ...
        subImg:
          "https://data-service.pharmacity.io/pmc-upload-media/production/pmc-ecm-core/products/P24394_5.jpg",
      ...
      },
      {
        id: 45,
        imgSrc:
          "https://data-service.pharmacity.io/pmc-upload-media/production/pmc-ecm-core/products/P25951_1.jpg",
        alt: "post",
        category: "Dược - Mỹ phẩm",
        categoryName: "Chăm sóc sắc đẹp",
        ...
        info: "",
        description:
          "Thành phần. Gel silicon polymer (CPX) và Vitamin C Ester. Công dụng. Dermatix® Ultra Kids là sản phẩm xử lý sẹo tiên tiến đã được chứng minh hiệu quả trên phác đồ xử lý sẹo như: - Té ngã. - Bỏng.",
        subImg:
          "https://data-service.pharmacity.io/pmc-upload-media/production/pmc-ecm-core/products/P25951_2.jpg",
  ...
  function displayProducts(products) {
    ...
    const randomNumbersList = generateRandomNumbers();
    productContainer1.innerHTML = "";
  
    // Lấy các sản phẩm tương ứng với các số ngẫu nhiên từ randomNumbersList
    const selectedProducts = randomNumbersList.map((randomNumber) => {
      // Lấy sản phẩm với id bằng với số ngẫu nhiên
      return products.find((product) => product.id === randomNumber);
    });
  
    // Tạo và hiển thị các phần tử sản phẩm
    selectedProducts.forEach((product) => {
      const productElement = createProductElement(product);
      productContainer1.appendChild(productElement);
    });
  }
  ...
  function displayProducts2(products) {
    ...
    // Lọc danh sách sản phẩm chỉ chứa những sản phẩm có category là "Thuốc không kê đơn"
    const filteredProducts = products.filter(product => product.categoryName === "Thực phẩm chức năng");
  
    // Lấy 4 sản phẩm đầu tiên từ danh sách đã lọc
  ...
  function displayProducts3(products) {
    productContainer3.innerHTML = "";
    const filteredProducts = products.filter(product => product.categoryName === "Chăm sóc sức khỏe");
  
    const slicedProducts = filteredProducts.slice(0, 4); // Lấy 5 sản phẩm đầu tiên
    ...
    displayProducts(storedProductsData);
    displayProducts2(storedProductsData);
